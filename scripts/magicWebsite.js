...
function buildMarvelStoryPage(characterName) {
  getMarvelCharacter(characterName, null, (container, name, description, imgUrl) => {
    buildStoryPage(name, description, imgUrl);
  });
}

function buildAnimeStoryPage(characterName) {
  getAnimeCharacter(characterName, null, (container, name, description, imgUrl) => {
    buildStoryPage(name, description, imgUrl);
  });
}

function buildStoryPage(characterName, description, imgUrl) {
